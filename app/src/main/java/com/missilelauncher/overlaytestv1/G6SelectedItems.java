...
public class G6SelectedItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        G6SelectedApps = new ArrayList<AppInfo>();
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                if (selectedIndex > -1) {
                    ...
                    G6SelectedApps.remove((AppInfo) parent.getItemAtPosition(position));
                } else {
        ...
        g2b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i< G6SelectedApps.size(); i++){
                    Log.v("g2 apps","App " + i +": " + G6SelectedApps.get(i).label);
                }
                Toast.makeText(G6SelectedItems.this,"Apps Saved!",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(G6SelectedItems.this, MainActivity.class);
