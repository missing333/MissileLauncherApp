...
public class G4SelectedItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gName.setText(sharedPrefs.getString("G4 Name","" ));
        gName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s){
                editor.putString("G4 Name", s.toString()).commit();
            }
        });
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("Name of G4", gName.getText().toString()).commit();

                for (int i = 0; i< G4SelectedApps.size(); i++){
                    Log.v("G4 apps","App " + i +": " + G4SelectedApps.get(i).label);
                }
